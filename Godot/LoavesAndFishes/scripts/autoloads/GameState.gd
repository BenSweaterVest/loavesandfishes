...
func from_dict(data: Dictionary) -> void:
	...
	collected_parables.assign(data.get("collected_parables", []))
	story_flags = data.get("story_flags", story_flags)
	unlocked_towns.assign(data.get("unlocked_towns", unlocked_towns))
	unlocked_fast_travel.assign(data.get("unlocked_fast_travel", unlocked_fast_travel))
	unlocked_miracles.assign(data.get("unlocked_miracles", unlocked_miracles))
