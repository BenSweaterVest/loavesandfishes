...
**21 unique fish species** with actual theological meaning:
- **Holy Mackerel**: The sacred fish of Galilee
- **Bass of Galilee**: Strong as Peter's faith
- **Carp Diem**: Seize the day!
- **Breadfish Divine**: Half bread, half fish, 100% miracle
- **Leviathan**: The chaos monster you can actually tame

Each fish has:
- Unique stats and movesets
- Elemental types (Holy, Water, Earth, Spirit, Dark)
- Lore tied to Biblical stories
- Evolution chains

### 2. The Apostles

**12 playable companions**, each with unique battle abilities:
- **Peter**: Rock Foundation (boosts party defense)
- **John**: Revelation Blast (massive Holy damage)
- **Matthew**: Tax Collection (steals money from enemies)
- **Thomas**: Doubting Strike (ignores defense)
- Even **Judas** (with a dangerous but powerful ability)

### 3. The World

**13 towns across ancient Israel**:
- Nazareth → Cana → Capernaum → ... → Jerusalem
- Each with unique NPCs, shops, bosses, and story
- Historically and geographically accurate
- Fast travel via "miracle teleportation"

### 4. The Content

- **50 quests**: Main story, side quests, apostle recruitment
- **25 collectible parables**: Teaching moments with gameplay bonuses
- **40 enemies**: From Skeptic Scorpions to the Seven Deadly Sins
- **13 bosses**: Each representing different obstacles to faith
- **4 miracles**: Limit breaks based on actual miracles
- **13 combo attacks**: Fish + Apostle team-up moves

### 5. The Tone

**Examples of the humor**:
- Fish names: Holy Mackerel, Bass-ic Instinct, Sole Survivor
- Bread items: Ryedemption Roll, Blessed Baguette, Unleavened Urgency
- Enemy types: Pharisee Follower, Money Changer, Doubt Incarnate
- Apostle quotes: "Upon this Bass I will build my church"

But also genuine moments:
- The weight of Judas's betrayal
- Peter's denial and redemption
- The struggle in Gethsemane
...
**Content** (100%):
- All 21 fish designed
- All 40 enemies designed
- All 13 bosses designed
- All 12 apostles with abilities
- All 50 quests written
- All 25 parables scripted
- All 13 towns mapped

**Advanced Systems** (100%):
- Apostle abilities
- Miracle system (4 limit breaks)
- Combo attacks
- Fishing mini-game
- Quest system
- Parable collection
...
**Integration** (Phase 2, ~40 hours):
- Connect advanced systems to main game loop
- Implement quest triggers
- Add random encounters
- Polish UI/UX

**Future Plans**:
- Graphics (pixel art or hand-drawn)
- Sound and music
- Mobile port (Godot or Unity)
- Steam release
...
- Release playable beta (text-based)
- Get community feedback
- Build core player base

### Medium Term (12 months)
- Commission artwork (pixel art style)
- Migrate to Godot engine
- Add graphics, animations, sound
- Release v1.0 on itch.io

### Long Term (18-24 months)
- Steam release
- Mobile ports (iOS/Android)
- Potential sequel: "Acts of the Apostles"
- Expand to New Testament stories

### Dream Goals
- Localization (Spanish, Portuguese, Korean)
- Multiplayer fish trading
- Community mod support
- Educational version for Sunday Schools
- Console ports (Switch would be perfect)

---

## WHO WE NEED

We're looking for passionate people who want to contribute:

### 🎨 Artists
**What We Need**:
- Pixel artist for fish sprites (21 species)
- Character artist for Jesus & apostles
- Environment artist for town backgrounds
- UI designer for menus and battle screens

**What You Get**:
- Portfolio piece with unique concept
- Revenue share on sales
- Creative input on art direction
- Your name in credits

**Time Commitment**: Flexible, can be project-based or ongoing

---

### 🎵 Musicians/Sound Designers
**What We Need**:
- Composer for Biblical-themed JRPG music
- Sound designer for effects (battles, fishing, etc.)
- Chiptune or orchestral style

**What You Get**:
- Revenue share
- Full creative freedom within theme
- Credits and promotional materials

**Time Commitment**: 8-12 tracks, ~20-40 sound effects

---

### 💻 Programmers
**What We Need**:
- Python developers (current codebase)
- Godot developers (for migration)
- UI/UX specialists
- Mobile developers (future)

**What You Get**:
- Learn game development
- Work with clean, well-documented code
- Revenue share for significant contributions
- Portfolio piece

**Time Commitment**: Flexible, issues labeled by difficulty

---

### ✍️ Writers
**What We Need**:
- Dialogue polish (make it funnier/more touching)
- Additional quest writers
- Parable educators (ensure accuracy)
- Lore expansion
...
**Time Commitment**: Variable, can be one-off contributions

---

### 🎮 Game Designers
**What We Need**:
- Balance specialists (stats, difficulty curves)
- System designers (new mechanics ideas)
- Level designers (town layouts, dungeons)
- UX designers (menu flow, accessibility)
...
**Time Commitment**: Consulting basis or ongoing

---

### 🧪 Playtesters
**What We Need**:
- People to play and provide feedback
- Bug reporters
- Suggestion makers
- Hype generators
...
**Time Commitment**: Play when you want, report what you find
...
### 1. This Is Unique
How many Biblical JRPGs exist? Exactly. This is virgin territory with huge potential.

### 2. It's Fun
This isn't homework. The concept makes people smile. The gameplay is solid. The puns are terrible (in a good way).

### 3. Portfolio Gold
"I made art/music/code for a Biblical fish-training game" is a conversation starter and portfolio piece that stands out.

### 4. Community
Join a team of creative people who care about making something great AND meaningful.

### 5. Potential
This could be:
- A commercial success (niche + quality = $$$)
- An educational tool
- A viral sensation ("Holy Mackerel goes viral")
- The start of a franchise

### 6. Revenue Share
We're committed to fair compensation:
- Core team: Equity/profit share
- Contributors: Based on contribution size
- Artists/Musicians: Commission + backend
...
### Viral Potential
- Holy Mackerel memes
- Fish pun compilation videos
- "Can you beat the game with only Judas?" challenges
- Speedruns to Jerusalem
- Apostle tier lists
...
- **README.md**: Overview and how to play
- **STATUS.md**: What's done, what's not
- **ROADMAP.md**: Future plans and platform strategy
- **ARCHITECTURE.md**: Technical details
- **CONTRIBUTING.md**: How to add content
- **MANUAL.md**: The world, lore, characters
...
### Step 4: Contribute
- **Easy**: Fix typos, add fish, balance numbers
- **Medium**: Write quests, design levels, create art
- **Advanced**: Code features, compose music, design systems
...
- ✅ Love the concept
- ✅ Have skills to contribute (or want to learn)
- ✅ Can commit some time (even a little helps)
- ✅ Want to be part of something unique
- ✅ Believe quality + faith can coexist

**Not Required**:
- ❌ Being religious (respect is enough)
- ❌ Being an expert (we'll teach you)
- ❌ Huge time commitment (contribute what you can)
- ❌ Money (this is passion project first, business second)
...
- **Website**: [Coming Soon]
- **Discord**: [Coming Soon]
- **Twitter**: @LoavesFishesRPG [Planned]
- **Email**: [Your Email]
...
A: The market is there. Christian media is huge but often low-quality. We're offering quality. Plus, the nostalgia gaming market is booming. Combine those? Potential.

**Q: What if it fails?**
A: We've already built something cool. Worst case: we have a fun game, learned new skills, and have a great story. Best case: this becomes a franchise. Either way, worth it.

**Q: Can I contribute if I'm not religious?**
A: Absolutely. We need diverse perspectives. Respect for the material is required; personal belief is not.

**Q: What's the timeline?**
A: Flexible. This is passion-project driven, not deadline-driven. We'd rather do it right than do it fast.
...
We're not trying to save the world—we're just trying to make a game about a guy who trained fish to help save the world.
...
*Teach a man to train weapon fish, and you've got a JRPG."*

🐟✨

---

**Ready to join the ministry? Let's talk.**
